...
export const PartCard: React.FC<PartCardProps> = ({
    ...
    return (
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-md border border-slate-200 print:shadow-none print:border-none relative group transition-all hover:shadow-lg">
